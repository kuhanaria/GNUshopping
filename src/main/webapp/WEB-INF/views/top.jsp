   ...
   <header class="header">
      ...
      <div class="menubar">
         <ul class="header__nav__right clearfix">
            ...
            if (userId == null) {
            %>
             <li><a href="<%=application.getContextPath()%>/login.jsp" id="login" class="header__nav__title">LOGIN</a></li>
             <li><a href="<%=application.getContextPath()%>/login.jsp" id="loginMy" class="header__nav__title">MYPAGE</a></li>
            <li><a href="<%=application.getContextPath()%>/login.jsp"class="header__nav__title">CART</a></li>
            <%
            } else {
            %>
